...
from sigma.envs.user import load_user, UserStrategy
...
class Env(object):
    ...
    def reset(self, task_index: Optional[int] = None) -> EnvResetResponse:
        ...
        self.actions = []
        # Reset user state, then generate initial message
        self.user.reset(instruction=self.task.instruction)
        initial_observation = self.user.generate_next_message(self.user.messages)
